...
Loading csv files containing the data. I’m using there `here` function
to feed a complete list of all the csv files in the Raw Data folder.
These files names are then mapped over to create a list of data frames,
renamed, and then saved separately to the global environment.
